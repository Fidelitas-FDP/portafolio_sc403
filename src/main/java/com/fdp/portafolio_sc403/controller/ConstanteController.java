...
import com.fdp.portafolio_sc403.service.ConstanteService;
...
public class ConstanteController {
    ...
    public String listado(Model model) {
        ...
        return "constante/listado"; // se quito "/" inicial para linux image de docker
    }
    ...
    public String modificar(@PathVariable("idConstante") Integer idConstante, Model model, RedirectAttributes redirectAttributes) {
        try {
            ...
            return "constante/modifica"; // se quito "/" inicial para linux image de docker
