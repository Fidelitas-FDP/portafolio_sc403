package com.fdp.portafolio_sc403.controller;

import com.fdp.portafolio_sc403.domain.Producto;
import com.fdp.portafolio_sc403.service.CategoriaService;
import com.fdp.portafolio_sc403.service.ProductoService;
...
//            @RequestParam("semanaPasada") @org.springframework.format.annotation.DateTimeFormat(iso = org.springframework.format.annotation.DateTimeFormat.ISO.DATE_TIME) java.time.LocalDateTime semanaPasada,
//            @RequestParam("hoy") @org.springframework.format.annotation.DateTimeFormat(iso = org.springframework.format.annotation.DateTimeFormat.ISO.DATE_TIME) java.time.LocalDateTime hoy,
//            Model model) {
//
//        var productos = productoService.getProductosPorFecha(semanaPasada, hoy);
//
//        model.addAttribute("productos", productos);
//        model.addAttribute("totalProductos", productos.size());
//
//        model.addAttribute("semanaPasada", semanaPasada);
